      ...
      <div class="row">
        <div class="cell-6 dark-half cell-12-sm">
          <div class="how-block">
            ...
            <ul>
              <li><span>Предоставляете пожелания, эскизы сайта, скриншоты в любой удобной для Вас форме</span></li>
        ...
        <div class="cell-6 light-half cell-12-sm">
          <div class="how-block">
            ...
            <ul>
              <li><span>Вникаем в ваш бизнес, обсуждаем все процессы, связанные с онлайн-решением</span></li>
              ...
              <li><span>После утверждения мы приступаем к интеграции дизайн-макета на современную CMS</span></li>
              <li><span>Устанавливаем готовый сайт на Ваш аккаунт и вносим по необходимости косметические правки</span></li>
...
<section class="client-reviews" id="reviews">
  ...
  <div class="container">
    <div class="row">
      <div class="cell-12">
        <div class="pagination-logos">
         <!-- тут рендерится пейджинация -->
        </div></div>
        <div class="cell-8">
        <div class="swiper-promo-wrap"><!-- Slider main container -->
          <div class="swiper-container js-reviews">
              <!-- Additional required wrapper -->
              <div class="swiper-wrapper">
                <!-- Slides -->
                <div class="swiper-slide" data-logo="/assets/images/jack2.jpg">
                  <div class="client-review-content">
                    <p>Выражаем благодарность команде IDBI за разработку сайта.</p>
                    <p>Выбор IDBI в качестве партнера при создании данного проекта был сделан достаточно быстро - за себя говорило обширное портфолио и высокое место в рейтинге разработчиков. И сейчас, оглядываясь на процесс сотрудничества и результат работ, мы с уверенностью можем сказать, что это был правильный шаг.</p>
                    <p>Процесс создания Интернет-магазина - это всегда долгая и рутинная работа, которая коллегами из IDBI была выполнена квалифицированно и своевременно. Начиная с дизайн-макета и заканчивая тонкой наладкой функциональности сайта, все этапы проходили согласно нашим требованиям и ожиданиям.</p>
                    <p>Хотим пожелать компании IDBI удерживать этот уровень профессионализма ещё долгое время!</p>
                  </div>
                  <div class="client-review-author">
                    <div>
                      <strong>Генеральный директор Янковская К.В. </strong>
                    </div>
                    <div>ilovemakeup.ru</div>
                  </div>
                </div>
                <div class="swiper-slide" data-logo="/assets/images/jack2.jpg">
                  <div class="client-review-content">
   ...
   <div class="very-cool">
    <span class="first-word"> — очень</span> <span class="second-word">круто</span><img src="/assets/images/woman.png" alt=""><span class="img-wrap"></span>
   </div>
...
<div class="mobile-app-block-wrap">
    ...
    <div class="left-block" data-aos="fade-up" data-aos-duration="600">
      ...
      <div class="image">
        ...
        <div class="mobile-app-video-wrap">
          <video class="mobile-app-video" src="https://cdn.idbi.ru/files/1/3163/19934299/original/mobile-app.mp4" loop="true" muted="true" webkit-playsinline="true" playsinline="true" autoplay="true"></video>
        </div>
      </div>
      
      <div class="description">Создаем интерфейсы аналитических систем, мобильные приложения и цифровые сервисы для крупного и мелкого бизнеса</div>
      
      <div class="text-bg">UX</div>
    </div>

    <div class="center-block" data-aos="fade-up" data-aos-duration="2000">
      <div class="image mobile-app-video-wrap"><video class="mobile-app-video" src="https://cdn.idbi.ru/files/1/3163/19934299/original/mobile-app.mp4" loop="true" muted="true" webkit-playsinline="true" playsinline="true" autoplay="true"></video></div>
    </div>
    
    <div class="right-block" data-aos="fade-up" data-aos-duration="600">
      <div class="title">Осмысленные интерфейсы</div>
      <div class="description">Разрабатываем крутые приложения для iOS и Android с фокусом на UX-дизайн</div>
      <button data-buy-id-place="252075126" class="btn js-modal" data-title="project3" href="#feedback-modal">Оставить заявку</button>
  ...
  <div class="step-list">
      <div class="step-list--item" data-aos="fade-up" data-aos-duration="200">
        ...
        <div class="description">Нетривиальные персонализированные интерфейсы, мобильные и веб-приложения с продуманным взаимодействием, никаких шаблонов и готовых решений</div>
      </div>
      <div class="step-list--item" data-aos="fade-up" data-aos-duration="600">
        ...
        <div class="description">Мы — не только про продажу, мы —
          про простоту восприятия, понимание и интуитивность. Наши продукты доносят идеи до пользователей, они понятны без инструкции и работают с первых дней</div>
      </div>
      <div class="step-list--item" data-aos="fade-up" data-aos-duration="800">
        ...
        <div class="description">Прорабатываем концепцию
          ...
          в проектах, в которых участвуем</div>
      </div>
  </div>
