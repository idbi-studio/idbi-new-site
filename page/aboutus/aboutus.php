                                        ...
                                        <div class="swiper-container js-reviews">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide" data-logo="/assets/images/jack2.jpg">
                                                    <div class="client-review-content" style="display:none;">
        ...
        <div class="row">
            <div class="cell-7 points">
                <div class="row">
                    <div class="cell-6">
                        <strong>— 1</strong>
                        Повышение престижа компании, становление узнаваемого, оригинального фирменного стиля. Клиенты видят, что в сайт вложили много сил и стараний и не «отваливаются» из-за подозрительного внешнего вида, как это бывает у шаблонов.
                    </div>
                    <div class="cell-6">
                        <strong> — 2</strong>
                        Код, написанный по последним правилам верстки и программирования. Такие сайты индексируются поисковыми роботами во много раз лучше шаблонов.
                    </div>
                    <div class="cell-6">
                        <strong>— 3</strong>
                        Благодаря многолетней практике создания сайтов различной тематики (а их, на минуточку, более 500 проектов), мы собрали огромную базу знаний как повысить вашу конверсию и по итогу повысить прибыль.
                    </div>
                    <div class="cell-6">
                        <strong>— 4</strong>
                        Юридическая гарантия результата и качества — мы работаем по договору, в рамках которого закрепляем и передаем авторские права на разработку.
                    </div>
                </div>
            </div>
            <div class="cell-5 garant hide-xs">
                <p><span class="bg-text mousemove-follower">Чем выше конверсия вашего ресурса — тем выше прибыль. <br /> Достичь максимальной конверсии и есть наша главная задача.<i class="after"></i></span></p>
