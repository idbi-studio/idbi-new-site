$(document).ready(function () {
    ...
    let feedbackModals = document.querySelectorAll('.js-feedback-modal');
    feedbackModals.forEach(feedbackModal => {
        feedbackModal.querySelector('[type="submit"]').addEventListener('click', event => {
            event.preventDefault();

            let xhr = new XMLHttpRequest(),
                data = new FormData();

            data.append('name', feedbackModal.querySelector('[name="name"]').value);
            data.append('phone', feedbackModal.querySelector('[name="phone"]').value);
            data.append('email', feedbackModal.querySelector('[name="email"]').value);

            let contentInput =  feedbackModal.querySelector('[name="content"]');
            if (contentInput) {
